...
public class SampleErpUserController {
    ...
    public String add() {
        ...
        ErpUser erpUser1 = new ErpUser("userid1", passwordEncoder.encode("123456"), "홍길동", "010-1111-1111", "서울시 강남구", "abc@naver.com", 1, birthday1, joindate1, 1, 0, 0, null, null);

        // 첫 번째 사용자 추가
        erpUserService.addErpUser(erpUser1);

        // UI로 리다이렉션 (예: 성공 페이지로)
        return "redirect:/success"; // 성공 페이지의 URL로 리다이렉트
    }
//    @RequestMapping(value = "/member/add", method = RequestMethod.GET)
//    @ResponseBody
//    public String add() {
...
//        LocalDate birthday1 = LocalDate.of(1990, 5, 20);
//        LocalDate joindate1 = LocalDate.of(2020, 3, 1);
//        ErpUser erpUser1 = new ErpUser("xyz789", passwordEncoder.encode("123456"), "홍길동", "010-1111-1111", "서울시 강남구", "abc@naver.com", 1, birthday1, joindate1, 1, 0, 0, null, null);
//
////        // 두 번째 임시 사용자
...
////
//        ErpAuth auth1 = new ErpAuth("xyz789", "ROLE_SUPER_ADMINISTRATOR", null);
